...
export const ProblemOutcomeTable: React.FC<ProblemOutcomeTableProps> = ({
  items
}) => {
  return <div className="bg-background rounded-lg shadow-sm border">
      <Table>
        ...
        <TableBody>
          {items.map((po, idx) => <TableRow key={idx} className="hover:bg-muted/50 transition-smooth">
